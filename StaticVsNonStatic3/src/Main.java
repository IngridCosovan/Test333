...
public class Main {
    ...
    Telefon telefon3 = new Telefon("Huawei", "Lite10");

        System.out.println("Am generat " + Telefon.numarTelefoaneGenerate + " de telefoane");

        Telefon telefon4 = new Telefon("Iphone", "7");
        ...
        Produs produs3 = new Produs("Geaca", 100);
